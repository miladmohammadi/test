...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: PpjYmw9iHGa/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: X6tyHNypLoI/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 9lxTIkV9hza/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__yqxKj)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__jj58)}
                role={"img"}
              />
            ),
